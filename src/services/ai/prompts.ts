export const startWeekPrompt = (desc: string) => {
  ...
  It is of the utmost importance that you get the dates 100% ACCURATE, there should no erros in the dates in any way, shape or form, no years, dates, months should be messed up, you start from today's date and today's date only 
...
export const getNextWeekPrompt = (
  tasks: string,
  weekNo: number,
  totalWeeks: number
) => {
