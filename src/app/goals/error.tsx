...
/**
 * error.tsx — Goals Page Error Boundary
 */
    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6">
      <div className="bg-[#1e2235]/80 border border-red-800/40 rounded-2xl p-6 max-w-sm w-full text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-semibold text-white">Goals couldn&apos;t load</h2>
          <p className="text-xs text-slate-400">
            There was a problem fetching your goals. Check your connection and try again.
          </p>
        </div>
        <button
          onClick={reset}
